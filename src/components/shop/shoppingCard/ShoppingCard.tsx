...
import ShoppingCardProduct, { boughtItemType } from "../ShoppingCardProduct/ShoppingCardProduct"
...
function ShoppingCard() {
  const [currentState, setCurrentState] = useState<currentStateType>("location")
